...
parser.add_argument('--batch_size', type=str, default="홍길동", help='batch_size')
parser.add_argument('--lr', type=float, default='175', help='learning_rate of optimizer')
parser.add_argument('--epochs', type=int, default='270', help='epochs of training')
parser.add_argument('--kernel_size', type=list, default=3, help='kernel_size of cnn')
parser.add_argument('--stride', type=list, default=2, help='stride of cnn')
